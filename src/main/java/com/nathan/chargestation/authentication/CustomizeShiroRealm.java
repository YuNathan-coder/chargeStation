...
import com.nathan.chargestation.common.enums.RoleEnums;
import com.nathan.chargestation.common.holder.UserHolder;
...
public class CustomizeShiroRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        } else if (roleId.equals(RoleEnums.EQUIPMENT_MANAGER.type)) {
            roleName = RoleEnums.EQUIPMENT_MANAGER.role;
        } else if (roleId.equals((RoleEnums.EQUIPMENT_REPAIRMAN.type))) {
            roleName = RoleEnums.EQUIPMENT_REPAIRMAN.role;
        }
